...
window.currentSlide = currentSlide;
window.changeHeroSlide = changeSlide;
window.currentHeroSlide = currentSlide;
window.loadArtifactsByGallery = loadArtifactsByGallery;
window.initializeHeroSlideshow = initializeHeroSlideshow;
window.initializeFeaturedSlideshow = initializeFeaturedSlideshow;
window.changeFeaturedSlide = changeFeaturedSlide;
window.currentFeaturedSlide = currentFeaturedSlide;