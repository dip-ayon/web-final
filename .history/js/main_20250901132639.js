        ...
        <div class="artifact-card" data-aos="fade-up">
            ...
            <div class="artifact-info">
                ...
                <div class="artifact-meta">
                    <span><i class="fas fa-hashtag"></i> ${a.collection_no || 'N/A'}</span>
                    <span><i class="fas fa-user"></i> ${a.donor || 'Unknown'}</span>
                </div>
                <p>${a.description}</p>
                <div class="artifact-tags">
                    <span class="tag">${a.object_type || 'Artifact'}</span>
                    <span class="tag">${a.collection_date || '1971'}</span>
                </div>
            </div>
        </div>
    `).join('');
